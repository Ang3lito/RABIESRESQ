...
CREATE TABLE IF NOT EXISTS cases (
  ...
  who_category_auto TEXT,
  who_category_final TEXT,
  who_category_reasons_json TEXT,
  who_category_version TEXT,
...
CREATE TABLE IF NOT EXISTS appointments (
  ...
  type TEXT NOT NULL,
  case_id INTEGER NOT NULL,
  patient_hidden INTEGER NOT NULL DEFAULT 0 CHECK(patient_hidden IN (0,1)),
